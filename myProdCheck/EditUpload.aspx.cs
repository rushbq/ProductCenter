...
public partial class myProdCheck_EditUpload : SecurityIn
{
    ...
    protected void lv_Files_Check_ItemCommand(object sender, ListViewCommandEventArgs e)
    {
    ...
    public string PageUrl
    {
        get
        {
            return "{0}myProdCheck/EditUpload.aspx?DataID={1}".FormatThis(
                Application["WebUrl"]
                , Req_DataID);
        }
        set
