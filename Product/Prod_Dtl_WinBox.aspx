<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Prod_Dtl_WinBox.aspx.cs"
    Inherits="Prod_Dtl_WinBox" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function reCheck_Items(){
            //取得母頁已選取的值
            var getInputVal = parent.document.getElementById('val_<%=Param_CateID %><%=Param_SpecID %>').value;
