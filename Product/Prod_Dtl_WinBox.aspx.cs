...
public partial class Prod_Dtl_WinBox : SecurityIn
{
    ...
    protected void lvDataList_ItemDataBound(object sender, ListViewItemEventArgs e)
    {
        if (e.Item.ItemType == ListViewItemType.DataItem)
        {
            ...
            //lt_Pic.Text = (string.IsNullOrEmpty(Pic)) || Pic.Equals("0") ? "" : PicUrl(Pic);
    ...
    protected void btn_Add_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string js = string.Format(
                "parent.$('#val_{4}{0}').val('{1}');" +
                "parent.$('#url_{4}{0}').text('{2}');" +
                "parent.$('#url_{4}{0}').removeClass().addClass('{3}');" +
    ...
    public string Param_CateID
    {
        get
        {
            string CateID = Request.QueryString["CateID"] == null ? "" : Request.QueryString["CateID"].ToString();

            return this._Param_CateID != null ? this._Param_CateID : CateID;
        }
        private set
        {
