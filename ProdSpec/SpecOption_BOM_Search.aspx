<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SpecOption_BOM_Search.aspx.cs"
    Inherits="SpecOption_BOM_Search" %>
...
<head runat="server">
    ...
    <script type="text/javascript" language="javascript">
        $(function () {
            ...
            //AutoComplete - 欄位群組
            $("#tb_GID").autocomplete('../AC_SpecOption_BOM_Group.aspx');
            $("#tb_GID").result(
...
<body class="MainArea">
    ...
    <div class="Navi">
        <a href="../Main.aspx">系統首頁</a>&gt;<a>產品資料庫</a>&gt;<a>組合明細規格設定</a>&gt;<span>組合明細選單</span>
    </div>
    <div class="h2Head">
        <h2>
            組合明細選單列表</h2>
    ...
    <div class="Sift">
        <ul>
            ...
            <li>組合明細選單單頭：<asp:TextBox ID="tb_GID" runat="server" MaxLength="5" Width="180px"></asp:TextBox>
            </li>
            <li>
                ...
                |
                <input type="button" class="EditBox btnBlock colorBlue" value="資料新增" title="組合明細選單 - 新增"
                    href="SpecOption_BOM_Edit.aspx?func=add&OptionGID=<%=this.tb_GID.Text %>" />
    ...
    <asp:ListView ID="lvDataList" runat="server" ItemPlaceholderID="ph_Items" OnItemCommand="lvDataList_ItemCommand"
        ...
        <ItemTemplate>
            <tr id="trItem" runat="server">
                ...
                <td align="center">
                    <a class="Edit EditBox" title="組合明細選單 - 修改" href="SpecOption_BOM_Edit.aspx?func=edit&OptionID=<%# Server.UrlEncode(Cryptograph.Encrypt(Eval("OptionID").ToString()))%>">
                        修改</a>
