<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SpecOptionGP_BOM_Search.aspx.cs"
    Inherits="SpecOptionGP_BOM_Search" %>
...
<body class="MainArea">
    ...
    <div class="Navi">
        <a href="../Main.aspx">系統首頁</a>&gt;<a>產品資料庫</a>&gt;<a>規格設定</a>&gt;<span>組合明細選單單頭設定</span>
    </div>
    <div class="h2Head">
        <h2>
            組合明細選單單頭列表</h2>
    ...
    <div class="Sift">
        <ul>
            <li>關鍵字：<asp:TextBox ID="tb_Keyword" runat="server" MaxLength="50" ToolTip="組合明細選單單頭/名稱查詢"></asp:TextBox>
            </li>
            <li>是否關聯：
            ...
            <li>
                ...
                |
                <input type="button" class="EditBox btnBlock colorBlue" value="資料新增" title="組合明細選單單頭 - 新增"
                    href="SpecOptionGP_BOM_Edit.aspx" />
    ...
    <asp:ListView ID="lvDataList" runat="server" ItemPlaceholderID="ph_Items" OnItemCommand="lvDataList_ItemCommand"
        ...
        <ItemTemplate>
            <tr id="trItem" runat="server">
                ...
                <td align="center">
                    <a class="Edit EditBox" title="組合明細選單單頭 - 修改" href="SpecOptionGP_BOM_Edit.aspx?OptionGID=<%# Server.UrlEncode(Cryptograph.Encrypt(Eval("OptionGID").ToString()))%>">
                        修改</a>
                    ...
                    <a class="BtnFour" href="SpecOption_BOM_Search.aspx?GID=<%# Server.UrlEncode(Eval("OptionGID").ToString())%>">
                        設定選單</a>
    ...
    <div class="ListIllusArea">
        <div class="JQ-ui-state-highlight">
            ...
            <div>
                <span class="JQ-ui-icon ui-icon-info"></span>此設定為下拉選單的單頭，完成後需再前往「<a href="SpecOption_BOM_Search.aspx">選單</a>」設定所屬的選單內容</div>
        </div>
    </div>
    </form>
</body>
