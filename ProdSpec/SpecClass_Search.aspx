<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SpecClass_Search.aspx.cs"
    Inherits="SpecClass_Search" %>
    ...
    <script type="text/javascript" language="javascript">
        $(function () {
            ...
            $("input#clear_form").click(function () {
                $("select#ddl_ClassType")[0].selectedIndex = 0;
...
<body class="MainArea">
    ...
    <div class="Navi">
        <a href="../Main.aspx">系統首頁</a>&gt;<a>產品資料庫</a>&gt;<a>規格設定</a>&gt;<span>分類設定</span>
    </div>
    <div class="h2Head">
        <h2>
            分類列表</h2>
    ...
    <div class="Sift">
        ...
        <ul>
            <li>類別型態：
                <asp:DropDownList ID="ddl_ClassType" runat="server" Width="135px">
                    <asp:ListItem Value="">-- 所有類別 --</asp:ListItem>
                    <asp:ListItem Value="1">大分類</asp:ListItem>
                    <asp:ListItem Value="2">小分類</asp:ListItem>
                </asp:DropDownList>
            </li>
            <li>
            ...
            <tr id="trItem" runat="server">
                <td align="left">
                    <span class="styleGreen B">
                        <%# Eval("SpecClassID")%></span> - <span class="L2MainHead">
                            <%# Eval("ClassName_zh_TW")%>
                        </span>
                </td>
                ...
                <td align="center">
                    <a class="Edit EditBox" title="規格分類 - 修改" href="SpecClass_Edit.aspx?SpecClassID=<%# Server.UrlEncode(Cryptograph.Encrypt(Eval("SpecClassID").ToString()))%>">
                        修改</a>
                    ...
                    <asp:PlaceHolder ID="ph_SetRel" runat="server"><a class="BtnFour" href="Spec_Frame_SpecClass.aspx?SpecClass=<%# Server.UrlEncode(Eval("SpecClassID").ToString())%>">
                        關聯設定</a> </asp:PlaceHolder>
                    <asp:HiddenField ID="hf_SpecClassID" runat="server" Value='<%# Eval("SpecClassID")%>' />
                </td>
            </tr>
        </ItemTemplate>
        <EmptyDataTemplate>
    ...
    <div class="ListIllusArea">
        <div class="JQ-ui-state-highlight">
            <div>
                <span class="JQ-ui-icon ui-icon-info"></span>設定產品主檔的規格類別選單</div>
        </div>
    </div>
    </form>
</body>
