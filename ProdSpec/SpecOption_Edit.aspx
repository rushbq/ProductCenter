<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SpecOption_Edit.aspx.cs"
    Inherits="SpecOption_Edit" %>
...
<body class="MainArea">
    ...
    <div class="SubmitArea">
        ...
        <asp:Button ID="btn_Next" runat="server" Text="下一步" OnClick="btn_Next_Click" CausesValidation="false"
            Visible="false" Width="90px" CssClass="btnBlock colorBlue" />
