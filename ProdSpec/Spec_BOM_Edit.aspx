<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Spec_BOM_Edit.aspx.cs" Inherits="Spec_BOM_Edit" %>
        ...
        <table class="TableModify">
            ...
            <tr class="Must">
                ...
                <td class="TableModifyTd styleBlue">
                    <asp:Literal ID="lt_BOM_SpecID" runat="server">系統自動編號</asp:Literal>
                </td>
            </tr>
            <tr class="Must">
                ...
                <td class="TableModifyTd">
                    ...
                    <asp:TextBox ID="tb_SpecID" runat="server" Width="70px" Style="background: #efefef;"></asp:TextBox>
                    <span class="SiftLight">(輸入規格欄位關鍵字)</span>
                    <asp:RequiredFieldValidator ID="rfv_tb_SpecID" runat="server" Display="Dynamic" ControlToValidate="tb_SpecID"
                        ErrorMessage="-&gt; 請選擇「所屬規格欄位」" ForeColor="Red" ValidationGroup="GPAdd"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr class="Must">
                <td class="TableModifyTdHead">
                ...
                <td class="TableModifyTd">
                    ...
                    <asp:RequiredFieldValidator ID="rfv_tb_SpecName" runat="server" Display="Dynamic"
                        ControlToValidate="tb_SpecName_zh_TW" ErrorMessage="-&gt; 請輸入「BOM規格欄位名稱」" ForeColor="Red"
            ...
            <tr>
                <td class="TableModifyTdHead">使用選單單頭
                </td>
                <td class="TableModifyTd">
            ...
            <tr>
                <td class="TableModifyTdHead">BOM規格欄位說明
                </td>
                <td class="TableModifyTd">
            ...
            <tr>
                <td class="TableModifyTdHead">是否顯示
                </td>
                <td class="TableModifyTd">
